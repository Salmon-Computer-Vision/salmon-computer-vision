...
class TrackerTest(unittest.TestCase):
    ...
    def test_calculate_centroid(self):
        ...
        tracker = Tracker(self.__build_stats())
        centroid = tracker._Tracker__calculate_centroid(xywh)
    ...
    def test_is_same_object_within_radius(self):
        ...
        tracker = Tracker(self.__build_stats())
        self.assertTrue(tracker._Tracker__is_same(xywh1, xywh2, r))
    ...
    def test_is_same_object_outside_radius(self):
        ...
        tracker = Tracker(self.__build_stats())
        self.assertFalse(tracker._Tracker__is_same(xywh1, xywh2, r))
